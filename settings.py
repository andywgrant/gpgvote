"""
Django settings for gpgvote project.
...
SECRET_KEY = 'z^$c##a%em3prkkwgxuuv&+kyh^zg@&@r73iovl+)#ox1ksrkk'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/Users/agrant/Projects/gpgvote-ag/gpgvote/gpgvote/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# WSGI_APPLICATION = 'gpgvote.wsgi.application'
...
GNUPGHOME = '/path/to/gpgvote/gnupg_keyring'
SYSTEM_KEY_FINGERPRINT = 'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF' # key of the system authority, used to sign PGP messages
